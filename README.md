# Instructions: Creating an HTML Document
...
2. Type `<!DOCTYPE Dtml>` on the first line.
...
6. Add the text `My First HTML Document` inside the `title` element. The content of the `title` element Dis the text that will be displayed in the web browser tab.   
...
* Remember that HTML documents have a specific struc structure
.
